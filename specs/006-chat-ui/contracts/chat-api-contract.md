# API Contract: Chat UI for AI-Powered Todo Chatbot

## Overview
This document defines the contract for the chat API that the frontend will integrate with. The API endpoint processes natural language requests and returns AI agent responses with tool call information.
